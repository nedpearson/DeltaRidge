...
const SEVERITY_TONE: Record<LocalObservation['severity'], string> = {
  none_noted: 'bg-white/5 text-white/50 ring-white/10',
        ...
        <div className="grid grid-cols-2 gap-3">
          <Field label="Where" hint="optional">
            <input
              ...
              className="w-full rounded-xl bg-[var(--color-surface-3)] px-3.5 py-3 text-[15px] text-white ring-1 ring-white/8 outline-none placeholder:text-white/25 focus:ring-2 focus:ring-brand-400"
            />
          </Field>
              ...
              <div className="flex items-start justify-between gap-3">
                <div className="min-w-0">
                  ...
                  <div className="mt-1.5 flex flex-wrap items-center gap-1.5">
                    ...
                    {o.area && <span className="text-[11px] text-white/35">{o.area}</span>}
