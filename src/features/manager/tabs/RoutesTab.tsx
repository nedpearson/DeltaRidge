...
export default function RoutesTab({
  ...
  if (routes.length === 0) {
    return loading ? (
      <Card>
        <p className="text-[12.5px] text-white/45">Reading routes…</p>
      </Card>
    ) : (
      <Nothing
...
function OneRoute({
  ...
  return (
    <div className="space-y-3">
      <button onClick={onBack} className="text-[12.5px] font-medium text-white/50">
        ← All routes
      </button>
      ...
      <Card>
        ...
        <div className="mt-3 space-y-1 border-t border-white/5 pt-2 text-[11.5px] leading-relaxed text-white/40">
          <p>
          ...
          <div className="mt-2 space-y-2.5">
            {signals.map((signal) => (
              <div key={signal.code}>
                ...
                <p className="mt-0.5 text-[11.5px] leading-relaxed text-white/35">{signal.check}</p>
              </div>
            ))}
          </div>
          <p className="mt-2.5 border-t border-white/5 pt-2 text-[11px] leading-relaxed text-white/30">
